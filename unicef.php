  ...
  <div class="col-lg-8 mx-auto p-4 py-md-5">
    ...
    <main>
      <div class="intro">
        ...
        <div class="image">
          <img src="images/unicef1.jpeg" alt="Your Image">
        </div>
      </div>
      ...
      <div class="container1">
        <div class="text-box">
            <h2>"CLEAN WATER, PROPER SANITATION AND GOOD HYGIENE FOR EVERY CHILD"</h2>
            <p>"Empowering Lives, One Drop at a Time: Short Liquid Gifts, Endless Streams of Change"</p>
        </div>
        <div class="image-container">
            <img src="images/unicef2.jpeg" alt="Eyecatching image">
        </div>
    </div>
