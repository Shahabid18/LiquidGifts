  ...
  <div class="col-lg-8 mx-auto p-4 py-md-5">
    ...
    <main>
      <div class="intro">
        ...
        <div class="image">
          <img src="images/thewaterproject1.jpeg" alt="Your Image">
        </div>
      </div>
      ...
      <div class="container1">
        <div class="text-box">
            <h2>"Access to safe water is foundational to the development of any community. "</h2>
            <p>"Empowering Lives, One Drop at a Time: Short Liquid Gifts, Endless Streams of Change"</p>
        </div>
        <div class="image-container">
            <img src="images/thewaterproject2.jpeg" alt="Eyecatching image">
        </div>
    </div>
