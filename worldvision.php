  ...
  <div class="col-lg-8 mx-auto p-4 py-md-5">
    ...
    <main>
      <div class="intro">
        ...
        <div class="image">
          <img src="images/worldvision1.jpeg" alt="Your Image">
        </div>
      </div>
      ...
      <div class="container1">
        <div class="text-box">
            <h2>"World Vision is reaching one new person with clean water every 10 seconds"</h2>
            <p>"Empowering Lives, One Drop at a Time: Short Liquid Gifts, Endless Streams of Change"</p>
        </div>
        <div class="image-container">
            <img src="images/worldvision2.jpeg" alt="Eyecatching image">
        </div>
    </div>
