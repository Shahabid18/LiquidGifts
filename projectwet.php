  ...
  <div class="col-lg-8 mx-auto p-4 py-md-5">
    ...
    <main>
      <div class="intro">
        ...
        <div class="image">
          <img src="images/WET.png" alt="Your Image">
        </div>
      </div>
      ...
      <div class="container1">
        <div class="text-box">
            <h2>"Advancing water education to understand global challenges and inspire local solutions"</h2>
            <p>"Empowering Lives, One Drop at a Time: Short Liquid Gifts, Endless Streams of Change"</p>
        </div>
        <div class="image-container">
            <img src="images/WET2.png" alt="Eyecatching image">
        </div>
    </div>
