...
<head>
  ...
  <title>Global water challenge</title>
  ...
  <div class="col-lg-8 mx-auto p-4 py-md-5">
    ...
    <main>
      <div class="intro">
        ...
        <div class="image">
          <img src="images/globalwaterchallenge1.jpeg" alt="Your Image">
        </div>
      </div>
      ...
      <div class="container1">
        <div class="text-box">
            <h2>"Mobilizing collective action to deliver clean water for all"</h2>
            <p>"Empowering Lives, One Drop at a Time: Short Liquid Gifts, Endless Streams of Change"</p>
        </div>
        <div class="image-container">
            <img src="images/globalwaterchallenge2.jpeg" alt="Eyecatching image">
        </div>
    </div>
    ...
    <button><a class="navbar-brand" href="donations.php">Donate</a></button>
    </h2>
    ...
    <footer class="pt-5 my-5 text-muted border-top">
      Shah Abid Shahriyar & Jamal Muse &middot; &copy; 2023
    </footer>
  </div>
